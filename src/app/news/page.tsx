    ...
    <div className='flex justify-center'>
      <div className='min-h-36 w-96 bg-zinc-600/25 rounded-xl p-4'>
        <div className='flex flex-col gap-2 justify-evenly w-full'>
          <h1 className='w-1/2 h-6 bg-zinc-200/25 rounded-sm animate-pulse'></h1>
          <div className='flex flex-col gap-1'>
            <h2 className='w-full h-2 bg-zinc-200/25 rounded-sm animate-pulse'></h2>
            <h2 className='w-3/4 h-2 bg-zinc-200/25 rounded-sm animate-pulse'></h2>
            <h2 className='w-2/4 h-2 bg-zinc-200/25 rounded-sm animate-pulse'></h2>
          </div>
          <h5 className='w-1/3 h-7 rounded-md animate-pulse delay-100 bg-zinc-200/25 '></h5>
        </div>
      </div>
    </div>
  )
