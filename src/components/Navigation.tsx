...
const Navigation = async ({children}: {children: React.ReactNode}) => {
  ...
  return (
    ...
    <div className="m">
      ...
      <div className="m-5">
        <nav className={` bg-stone-400 h-16 w-full max-w-lg mx-auto relative z-[1] overflow-hidden flex justify-center items-center dark:bg-stone-700 rounded-xl p-3 shadow-xl dark:shadow-stone-800`}>
          ...
          <div className='absolute h-52 z-[1] aspect-square rounded-full blur-xl left-0 top-0 moving bg-stone-300/50 dark:bg-stone-600/50 transition-all'/>
        </nav>
      </div>
      <div className="z-10">
        {children}
      ...
      <div className='w-full pt-6 grid place-items-center'>
        <nav className={`flex relative  justify-center items-center mx-5 mb-5 rounded-xl p-3 bg-stone-400 dark:bg-stone-700 `}>
