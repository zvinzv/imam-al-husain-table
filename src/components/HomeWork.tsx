...
export default async function HomeWork() {
  ...
  let data = {
    ...
    body: {
      1: [["1", "احياء", (GetSubjectDescription("biology") as Sub).homeWork.title],      ["2", "فيزياء", (GetSubjectDescription("physics") as Sub).homeWork.title],    ["3", "انكليزي", (GetSubjectDescription("english") as Sub).homeWork.title],   ["4", "رياضيات", (GetSubjectDescription("math") as Sub).homeWork.title],   ["5", "أرض",  ( GetSubjectDescription("earth") as Sub).homeWork.title]],
      2: [["1", "كيمياء", (GetSubjectDescription("chemistry") as Sub).homeWork.title],   ["2", "احياء", (GetSubjectDescription("biology") as Sub).homeWork.title],     ["3", "فنية", (GetSubjectDescription("paint") as Sub).homeWork.title],        ["4", "عربي", (GetSubjectDescription("arabic") as Sub).homeWork.title],    ["5", "فيزياء", (GetSubjectDescription("physics") as Sub).homeWork.title ]],
      3: [["1", "فيزياء", (GetSubjectDescription("physics") as Sub).homeWork.title],     ["2", "انكليزي", (GetSubjectDescription("english") as Sub).homeWork.title],   ["3", "رياضيات", (GetSubjectDescription("math") as Sub).homeWork.title],      ["4", "عربي", (GetSubjectDescription("arabic") as Sub).homeWork.title],    ["5", "حاسوب", (GetSubjectDescription("pc") as Sub).homeWork.title]],
      4: [["1", "احياء", (GetSubjectDescription("biology") as Sub).homeWork.title],      ["2", "عربي", (GetSubjectDescription("arabic") as Sub).homeWork.title],       ["3", "انكليزي", (GetSubjectDescription("english") as Sub).homeWork.title],   ["4", "اسلامية", (GetSubjectDescription("islamic") as Sub).homeWork.title ], ["5", "رياضيات", (GetSubjectDescription("math") as Sub).homeWork.title]],
      5: [["1", "كيمياء", (GetSubjectDescription("chemistry") as Sub).homeWork.title],   ["2", "عربي", (GetSubjectDescription("arabic") as Sub).homeWork.title],       ["3", "رياضيات", (GetSubjectDescription("math") as Sub).homeWork.title],      ["4", "اسلامية", (GetSubjectDescription("islamic") as Sub).homeWork.title ], ["5", "أرض", ( GetSubjectDescription("earth") as Sub).homeWork.title]],
    },
